...
class FootballScoreboard:
    def __init__(self, root):
        ...
        self.play_clock_seconds = 30  # Default play clock
        ...
        self.vibration_intensity = 1.0  # 0.0 to 1.0 scale
    ...
    def setup_gui(self):
        ...
        # Clock frame with weather and play clock
    ...
    def setup_display_window(self):
        ...
        display_frame = ttk.Frame(self.display_canvas, style="Display.TFrame")
        self.display_canvas.create_window(400, 200, window=display_frame, anchor="center")
    ...
    def start_play_clock(self):
        ...
        self.play_clock_seconds = 30  # Reset to default
    ...
    def update_display_background(self):
        ...
        if self.display_background:
            self.display_canvas.create_image(400, 200, image=self.display_background)
        self.display_canvas.create_window(400, 200, window=self.display_canvas.winfo_children()[0], anchor="center")
