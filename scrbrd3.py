...
class FootballScoreboard:
    def __init__(self, root):
        ...
        self.play_seconds = 10  # Default play duration for Electric Football
    ...
    def setup_display_window(self):
        ...
        self.display_window.protocol("WM_DELETE_WINDOW", lambda: None)  # Prevent closing
    ...
    def run_play_timer(self):
        ...
        if self.vibration_on and self.clock_running:
            self.play_sound("vibration")  # Stop sound
